...
def start():
        ...
        with sr.Microphone() as source:
            ...
            try:    
                ...
                #if(txt not in'iPad save' and txt not in'iPad save' and txt not in 'iPad open' and txt not in 'iPad' and txt not in 'iPad stop' and txt not in 'iPad.' and txt not in 'iPad best' and txt not in 'iPad new' and txt not in 'iPad clear' and txt not in 'iPad delete' and txt not in 'iPad color'):
                #    mytext.insert(END,txt)
                globals()['b']=0    
                if('iPad stop' in txt or'iPad.' in txt ):   
                    ...
                    mytext.delete(1.0,END)
                elif'iPad play music'in txt:
                    url = 'https://www.youtube.com/watch?v=gnyW6uaUgk4'
                    try:
                        wb.get().open_new(url)
...
##bold buttonS
bold_icon = tk.PhotoImage(file='C:\work\mypadd/bold.png')
bold_btn  =ttk.Button(tool_bar ,image=bold_icon)
bold_btn.grid(row=0, column=2, padx=5)


 ##italic button
italic_icon = tk.PhotoImage(file='C:\work\mypadd/italic.png')
italic_btn=ttk.Button(tool_bar,image=italic_icon)
italic_btn.grid(row=0, column=3,padx=5)


##underline button
underline_icon = tk.PhotoImage(file='C:\work\mypadd/underline.png')
underline_btn=ttk.Button(tool_bar,image=underline_icon)
underline_btn.grid(row=0, column=4,padx=5)


##font color button
font_icon = tk.PhotoImage(file='C:\work\mypadd/font_color.png')
font_color_btn = ttk.Button(tool_bar,image=font_icon)
font_color_btn.grid(row=0, column=5,padx=5)

## align_left
align_left_icon = tk.PhotoImage(file='C:\work\mypadd/align_left.png')
align_left_btn=ttk.Button(tool_bar,image=align_left_icon)
align_left_btn.grid(row=0,column=6,padx=5)

##align center
align_center_icon = tk.PhotoImage(file='C:\work\mypadd/align_center.png')
align_center_btn= ttk.Button(tool_bar,image=align_center_icon)
align_center_btn.grid(row=0,column=7,padx=5)

##align right
align_right_icon = tk.PhotoImage(file='C:\work\mypadd/align_right.png')
...
##upper line gives a dictionary whose attributes we are changing
    if text_property.actual()['weight']=='normal' :
        mytext.configure(font=(current_font_family,current_font_size,'bold'))
    if text_property.actual()['weight']=='bold' :
        mytext.configure(font=(current_font_family,current_font_size,'normal'))
...
##upper line gives a dictionary whose attributes we are changing
    if text_property.actual()['slant']=='roman' :
        mytext.configure(font=(current_font_family,current_font_size,'italic'))
...
##upper line gives a dictionary whose attributes we are changing
    if text_property.actual()['underline']==0 :
        mytext.configure(font=(current_font_family,current_font_size,'underline'))
